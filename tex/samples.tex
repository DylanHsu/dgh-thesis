...
A notable exception is the $\ttbar \to 2\ell 2\nu 2b$ process, where the state-of-the-art NNLO calculation is used~\ref{Czakon:2013goa}.
...
Meanwhile, the actual pileup distribution in the collected data sample is measured~\ref{CMS:2017sdi}.

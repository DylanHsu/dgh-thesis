...
The final state in this search is a Z boson candidate decaying to charged leptons, recoiling against a lot of
missing energy from the undetectable particles.

\subsection{Preselection}
\label{ss:zlldmpresel}
First, events are selected which have exactly two electrons or muons.
They must be opposite-charged electrons (muons) with $\pt > 25 (20)~\GeV$ each.
The mass of the dilepton system ($\mll$) is required to be $\left|\mll-m_{\Z}\right| < 15\GeV$, consistent with the decay of a $\Z$ boson.
...
After the emulated \met procedure, the selection in Section~\ref{sec:zlldmsel} is applied.

...
These diboson processes quickly become the main problem due to the limitations
...
unity. This follows themethod originally proposed by Ref.~\cite{Gieseke:2014gka}:
\begin{equation}

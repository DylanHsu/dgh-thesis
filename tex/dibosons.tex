...
Additionally, a third well-identified electron or muon is required, representing the $\mathrm{W^\pm}$ boson.
...
In particular, note the presence of the expected Jacobian peak in the $\mathrm{W^\pm}$ boson transverse mass distribution in Figure~\ref{fig:wz3l_w}.
...
\caption{Kinematics of the reconstructed $\mathrm{W^\pm}$ boson at final selection level. Clockwise from upper left: 
$p_\mathrm{T}$ of the lepton associated with the $\mathrm{W^\pm}$ boson;
$\met$ in the event; transverse mass of the $\mathrm{W^\pm}$ boson;
and $p_\mathrm{T}$ of the $\mathrm{W^\pm}$ boson.

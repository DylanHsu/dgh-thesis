...
This chapter describes how the efficiency is measured in data and simulation by studying dilepton events where the dilepton mass is close to the Z boson resonance peak at 91.1876 $\GeV$.
...
% DGH: This is a bit more subtle than just counting the number of T&P pairs.
% It is a legacy remnant of Muon POG code that we used instead of fighting them.
% I do not know the real reason it is so complicated.
...
lowered transverse momentum cut of 3 $\GeV$. Then, the number of opposite sign tag-track pairs having system mass above
...
essentially random pairs of tag leptons and charged hadrons whose system mass falls within the relevant window.
...
\begin{figure}
	\centering
	\includegraphics[width=0.75\textwidth]{figures/tnpFits/ZeeEPiEMu.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_RecoTemplate_BkgLPi_pass_ptBin0_etaBin1.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_RecoTemplate_BkgLPi_fail_ptBin0_etaBin1.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_RecoTemplate_BkgLPi_pass_ptBin1_etaBin9.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_RecoTemplate_BkgLPi_fail_ptBin1_etaBin9.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_RecoTemplate_BkgLPi_pass_ptBin7_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_RecoTemplate_BkgLPi_fail_ptBin7_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_RecoTemplate_BkgLPi_pass_ptBin10_etaBin6.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_RecoTemplate_BkgLPi_fail_ptBin10_etaBin6.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_RecoTemplate_BkgLPiEMu_pass_ptBin0_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_RecoTemplate_BkgLPiEMu_fail_ptBin0_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_RecoTemplate_BkgLPiEMu_pass_ptBin1_etaBin19.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_RecoTemplate_BkgLPiEMu_fail_ptBin1_etaBin19.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_RecoTemplate_BkgLPiEMu_pass_ptBin3_etaBin23.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_RecoTemplate_BkgLPiEMu_fail_ptBin3_etaBin23.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_RecoTemplate_BkgLPiEMu_pass_ptBin14_etaBin17.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_RecoTemplate_BkgLPiEMu_fail_ptBin14_etaBin17.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_RecoTemplate_BkgAnalytic_pass_ptBin0_etaBin1.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_RecoTemplate_BkgAnalytic_fail_ptBin0_etaBin1.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_RecoTemplate_BkgAnalytic_pass_ptBin1_etaBin9.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_RecoTemplate_BkgAnalytic_fail_ptBin1_etaBin9.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_RecoTemplate_BkgAnalytic_pass_ptBin7_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_RecoTemplate_BkgAnalytic_fail_ptBin7_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_RecoTemplate_BkgAnalytic_pass_ptBin10_etaBin6.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_RecoTemplate_BkgAnalytic_fail_ptBin10_etaBin6.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_RecoTemplate_BkgAnalytic_pass_ptBin0_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_RecoTemplate_BkgAnalytic_fail_ptBin0_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_RecoTemplate_BkgAnalytic_pass_ptBin1_etaBin19.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_RecoTemplate_BkgAnalytic_fail_ptBin1_etaBin19.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_RecoTemplate_BkgAnalytic_pass_ptBin3_etaBin23.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_RecoTemplate_BkgAnalytic_fail_ptBin3_etaBin23.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_RecoTemplate_BkgAnalytic_pass_ptBin14_etaBin17.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_RecoTemplate_BkgAnalytic_fail_ptBin14_etaBin17.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_ResFunc_BkgLPi_pass_ptBin0_etaBin1.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_ResFunc_BkgLPi_fail_ptBin0_etaBin1.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_ResFunc_BkgLPi_pass_ptBin1_etaBin9.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_ResFunc_BkgLPi_fail_ptBin1_etaBin9.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_ResFunc_BkgLPi_pass_ptBin7_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_ResFunc_BkgLPi_fail_ptBin7_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_ResFunc_BkgLPi_pass_ptBin10_etaBin6.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_ResFunc_BkgLPi_fail_ptBin10_etaBin6.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_ResFunc_BkgLPiEMu_pass_ptBin0_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_ResFunc_BkgLPiEMu_fail_ptBin0_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_ResFunc_BkgLPiEMu_pass_ptBin1_etaBin19.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_ResFunc_BkgLPiEMu_fail_ptBin1_etaBin19.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_ResFunc_BkgLPiEMu_pass_ptBin3_etaBin23.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_ResFunc_BkgLPiEMu_fail_ptBin3_etaBin23.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_ResFunc_BkgLPiEMu_pass_ptBin14_etaBin17.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_ResFunc_BkgLPiEMu_fail_ptBin14_etaBin17.pdf}
...
It is more prevalent for electrons than for muons because bremsstrahlung is suppressed as the fourth power of lepton mass.
...
Instead, we decided to use POWHEG and then pursue a reweighting procedure to capture the effect.
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_PowhegPythia_BkgLPi_pass_ptBin0_etaBin1.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_PowhegPythia_BkgLPi_fail_ptBin0_etaBin1.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_PowhegPythia_BkgLPi_pass_ptBin1_etaBin9.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_PowhegPythia_BkgLPi_fail_ptBin1_etaBin9.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_PowhegPythia_BkgLPi_pass_ptBin7_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_PowhegPythia_BkgLPi_fail_ptBin7_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_PowhegPythia_BkgLPi_pass_ptBin10_etaBin6.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_PowhegPythia_BkgLPi_fail_ptBin10_etaBin6.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_PowhegPhotos_BkgLPi_pass_ptBin0_etaBin1.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_PowhegPhotos_BkgLPi_fail_ptBin0_etaBin1.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_PowhegPhotos_BkgLPi_pass_ptBin1_etaBin9.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_PowhegPhotos_BkgLPi_fail_ptBin1_etaBin9.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_PowhegPhotos_BkgLPi_pass_ptBin7_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_PowhegPhotos_BkgLPi_fail_ptBin7_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_PowhegPhotos_BkgLPi_pass_ptBin10_etaBin6.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_PowhegPhotos_BkgLPi_fail_ptBin10_etaBin6.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_PowhegPythia_BkgLPiEMu_pass_ptBin0_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_PowhegPythia_BkgLPiEMu_fail_ptBin0_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_PowhegPythia_BkgLPiEMu_pass_ptBin1_etaBin19.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_PowhegPythia_BkgLPiEMu_fail_ptBin1_etaBin19.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_PowhegPythia_BkgLPiEMu_pass_ptBin3_etaBin23.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_PowhegPythia_BkgLPiEMu_fail_ptBin3_etaBin23.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_PowhegPythia_BkgLPiEMu_pass_ptBin14_etaBin17.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_PowhegPythia_BkgLPiEMu_fail_ptBin14_etaBin17.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_PowhegPhotos_BkgLPiEMu_pass_ptBin0_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_PowhegPhotos_BkgLPiEMu_fail_ptBin0_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_PowhegPhotos_BkgLPiEMu_pass_ptBin1_etaBin19.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_PowhegPhotos_BkgLPiEMu_fail_ptBin1_etaBin19.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_PowhegPhotos_BkgLPiEMu_pass_ptBin3_etaBin23.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_PowhegPhotos_BkgLPiEMu_fail_ptBin3_etaBin23.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_PowhegPhotos_BkgLPiEMu_pass_ptBin14_etaBin17.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_PowhegPhotos_BkgLPiEMu_fail_ptBin14_etaBin17.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_AltTag_pass_ptBin0_etaBin1.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_AltTag_fail_ptBin0_etaBin1.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_AltTag_pass_ptBin1_etaBin9.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_AltTag_fail_ptBin1_etaBin9.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_AltTag_pass_ptBin7_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_AltTag_fail_ptBin7_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_AltTag_pass_ptBin10_etaBin6.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zmm_AltTag_fail_ptBin10_etaBin6.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_AltTag_pass_ptBin0_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_AltTag_fail_ptBin0_etaBin0.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_AltTag_pass_ptBin1_etaBin19.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_AltTag_fail_ptBin1_etaBin19.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_AltTag_pass_ptBin3_etaBin23.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_AltTag_fail_ptBin3_etaBin23.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_AltTag_pass_ptBin14_etaBin17.pdf}
\includegraphics[width=0.49\textwidth]{figures/tnpFits/Zee_AltTag_fail_ptBin14_etaBin17.pdf}
...
The percent impacts of each source of uncertainty on the inclusive Z($\ell\ell$) cross section
